...
})({"kpsOU":[function(require,module,exports) {
...
window.addEventListener("load", function() {
   ...
   */ const checkIndex = function(i) {
        if (i > els.length - 1) return i - els.length;
        else if (i < 0) return els.length - Math.abs(i);
        else return i;
    };
    /**
   ...
   */ const getActiveIndex = function() {
        ...
        els.forEach((element, index)=>{
            if (element.classList.contains("rg-item-active")) i = index;
        });
        return i;
    };
    /**
...
},{}]},["kpsOU","gLLPy"], "gLLPy", "parcelRequire2181")
